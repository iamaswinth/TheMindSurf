      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <div className="md:hidden flex items-center justify-between p-3 border-b-4 border-black bg-white">
          <button
            ...
            className="p-2 hover:bg-[#FFFEF0] border-2 border-black transition-colors"
                    ...
                    <div className="mb-4 md:mb-6">
                      <div className="relative max-w-md">
                        <input
                          ...
                          className="w-full px-4 py-3 pr-20 border-4 border-black text-black font-bold placeholder-black/40 focus:outline-none focus:ring-4 focus:ring-[#00FFFF]"
                          style={{
                        ...
                        {searchQuery && (
                          <button
                            ...
                            className="absolute right-2 top-1/2 -translate-y-1/2 px-3 py-1.5 text-xs font-black uppercase bg-[#FF006E] hover:bg-[#9D00FF] text-white border-2 border-black transition-colors"
                            style={{ boxShadow: "2px 2px 0px #000000" }}
                          >
                            CLEAR
                          </button>
                    ...
                    >
                      ...
                      {creditRequests.length === 0 ? (
                        <div className="p-6 md:p-8 text-center">
                          <p className="text-3xl md:text-4xl mb-3 md:mb-4">
                            ✨
                          </p>
